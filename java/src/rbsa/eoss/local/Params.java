...
public class Params {
    ...
    public Params( String p , String mode, String name, String run_mode, String search_clp)
    {
        ...
        dsm_dat_file = path + "\\dat\\all_dsms2014-09-11-18-55-05.dat";
        scores_dat_file = path  + "\\dat\\scores2014-09-13-16-00-00.dat";
        initial_pop = path + "\\results\\2014-09-13_10-12-56_test.rs";//2014-09-08_15-51-32_test
        //initial_pop = "";
